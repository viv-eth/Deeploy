...
from Deeploy.Targets.Generic.Templates import AddTemplate, ConcatTemplate, ConvTemplate, DebugPrintTemplate, \
    DequantTemplate, DummyTemplate, DWConvTemplate, EncodeTemplate, FloatAddTemplate, FloatConvTemplate, FloatDivTemplate, \
    FloatDWConvTemplate, FloatGELUTemplate, FloatGemmTemplate, FloatLayernormTemplate, FloatMatMulTemplate, FloatMaxPoolTemplate, \
...
from Deeploy.Targets.Generic.TypeCheckers import AddChecker, ConcatChecker, ConvChecker, DebugPrintChecker, \
    DequantChecker, DivChecker, DummyChecker, EncodeChecker, GatherChecker, GELUChecker, GEMMChecker, \
...
BasicEncodeBindings = NodeBinding(
    EncodeChecker([PointerClass(uint8_t)], [PointerClass(int32_t), PointerClass(int32_t)]),
    EncodeTemplate.referenceTemplate,
    BasicTransformer)
