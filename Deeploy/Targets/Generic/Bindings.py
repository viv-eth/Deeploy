...
from Deeploy.Targets.Generic.Templates import AddTemplate, ConcatTemplate, ConvTemplate, DebugPrintTemplate, \
    DecodeTemplate, DequantTemplate, DummyTemplate, DWConvTemplate, EncodeTemplate, FloatAddTemplate, \
...
from Deeploy.Targets.Generic.TypeCheckers import AddChecker, ConcatChecker, ConvChecker, DebugPrintChecker, \
    DecodeChecker, DequantChecker, DivChecker, DummyChecker, EncodeChecker, GatherChecker, GELUChecker, GEMMChecker, \
...
BasicEncodeBindings = NodeBinding(
    EncodeChecker([PointerClass(uint8_t), PointerClass(int32_t)],
                  [PointerClass(int32_t), PointerClass(int32_t)]), EncodeTemplate.referenceTemplate, BasicTransformer)

BasicDecodeBindings = NodeBinding(
    DecodeChecker([PointerClass(int32_t), PointerClass(int32_t)], [PointerClass(uint8_t)]),
    DecodeTemplate.referenceTemplate, BasicTransformer)
